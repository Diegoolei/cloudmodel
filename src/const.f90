!     Include para las constantes matematicas y fisicas para precipitacion
module const
      real, parameter :: pi=3.1415926,gam1p8=.9134,gam2p8=1.6765,&
         gam3p8=4.6941742,gam4p8=17.837862,G=9.8
      real, parameter :: Rd=287.04,Rv=461.05,Kapa=.2857,Eps=.622646,&
      ...
      real, parameter :: Dv0=2.11e-5,Vis0=1.718e-5,rhow=1000.,rhocri=900.&
      ...
      common /constants/Tvis,Tlvl,Tlsl,Tlvs,Telvs,Tesvs,Eautcn,Eacrcn
