...
contains
   ...
   subroutine initialize_model()
      ...
      ltt = sim_time_minutes*60.         !tiempo total de simulacion
      ltg = save_lapse_minutes*60.       !tiempo de grabacion
      lte = statistic_time_minutes*60.   !tiempo de grabacion estadistica
      ltb = backup_time_minutes*60.      !tiempo de backup
