...
!      similar al llehie2 pero sigue la nube solamente
...
!     Lectura del estado base
         ...
         do 100 k=0,nz1
            ...
            read(70,210) i,Temp0(k),Tita0(k),Presi0(k),Pres00(k),Den0(k),aer0(k),Qvap0(k),UU(k),VV(k)
...
!     inicializacion todas las variables en su estado base
  ...
  105    continue
         ...
         open(unit=30,file=entrav5d)

         write(30,*) fipasos+1-inpasos
         write(30,*) nvar
         write(30,*) ny1
         write(30,*) nx1
         write(30,*) nz1
...
!           pause
            ...
            open(unit=60,file=httfla,status='unknown',form='unformatted')
...
!      Escritura de las variables
   ...
   20       continue
     ...
     *               , entrav5d
         ...
         do 555 k=1,nz1
            write(*,*) k,Temp0(k),vars(1,16,k,4),vars(16,16,k,4)
            pause
  555    continue
